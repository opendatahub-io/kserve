...
func (r *LLMInferenceServiceReconciler) combineBaseRefsConfig(ctx context.Context, llmSvc *v1alpha2.LLMInferenceService, reconcilerConfig *Config) (*v1alpha2.LLMInferenceServiceConfig, error) {
...
func (r *LLMInferenceServiceReconciler) getConfig(ctx context.Context, llmSvc *v1alpha2.LLMInferenceService, name string) (*v1alpha2.LLMInferenceServiceConfig, error) {
...
func isDefaultBackendRef(llmSvc *v1alpha2.LLMInferenceService, ref gatewayapi.BackendRef) bool {
	defaultInfPoolName := (&v1alpha2.SchedulerSpec{}).InferencePoolName(llmSvc)
	return ptr.Deref[gatewayapi.Kind](ref.Kind, "") == "InferencePool" &&
