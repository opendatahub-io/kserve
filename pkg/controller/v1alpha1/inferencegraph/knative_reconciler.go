...
func setAutoScalingAnnotations(client client.Client,
	...
	if initialScaleInt > revisionMinScale {
		log.Info("WARNING: knative autoscaler is globally configured with an initial-scale value that is greater than the requested min-scale for the inference graph",
