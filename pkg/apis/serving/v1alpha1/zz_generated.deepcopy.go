...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GIEInferencePoolSpec) DeepCopyInto(out *GIEInferencePoolSpec) {
	*out = *in
	if in.Selector != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GIEInferencePoolSpec.
func (in *GIEInferencePoolSpec) DeepCopy() *GIEInferencePoolSpec {
	if in == nil {
		return nil
	}
	out := new(GIEInferencePoolSpec)
	in.DeepCopyInto(out)
	return out
}
