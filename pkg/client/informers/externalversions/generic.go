...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1alpha1.SchemeGroupVersion.WithResource("llminferenceserviceconfigs"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Serving().V1alpha1().LLMInferenceServiceConfigs().Informer()}, nil
	...
	case v1alpha2.SchemeGroupVersion.WithResource("llminferenceserviceconfigs"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Serving().V1alpha2().LLMInferenceServiceConfigs().Informer()}, nil
