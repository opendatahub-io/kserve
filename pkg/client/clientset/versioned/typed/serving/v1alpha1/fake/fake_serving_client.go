...
func (c *FakeServingV1alpha1) LLMInferenceServiceConfigs(namespace string) v1alpha1.LLMInferenceServiceConfigInterface {
	return newFakeLLMInferenceServiceConfigs(c, namespace)
}
