...
class TestCase:
    ...
    base_refs: List[str]
    api_version: str = "v1alpha1"  # API version to test (v1alpha1 or v1alpha2)
    ...
    # Factory provided
    llm_service: Any = None  # Generated by fixture (can be V1alpha1 or V1alpha2)
...
@log_execution
def test_llm_inference_service(api_version, test_case: TestCase):
...
@log_execution
def create_llmisvc(kserve_client: KServeClient, llm_isvc: Any):
    try:
...
@log_execution
def delete_llmisvc(kserve_client: KServeClient, llm_isvc: Any):
    try:
...
def get_llm_service_url(kserve_client: KServeClient, llm_isvc: Any):
...
def _collect_diagnostics(kserve_client: KServeClient, llm_isvc: Any):
