...
# Install KServe LLM InferenceService HPA autoscaling dependencies (Prometheus, Prometheus Adapter)
#
...
main() {
    ...
    echo "=========================================="
    echo "Install KServe LLM InferenceService HPA autoscaling dependencies (Prometheus, Prometheus Adapter)"
    echo "=========================================="
