...
require (
	...
	github.com/opendatahub-io/odh-platform-utilities v0.0.0-20260423135947-1b54a9a0878d
...
// Pin k8s.io dependencies to v0.34.x to keep compatibility with existing kserve code.
// odh-platform-utilities pulls in v0.35.x transitively but existing APIs are not yet migrated.
replace (
