...
**llm_inference_service_tls_min_version** | **str** | LLMInferenceServiceTLSMinVersion configures the minimum TLS version for LLMISVC components; vLLM receives it through an OpenSSL policy. | [optional] 
