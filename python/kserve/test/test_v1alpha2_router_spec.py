...
class TestV1alpha2RouterSpec(unittest.TestCase):
    """V1alpha2RouterSpec unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test V1alpha2RouterSpec
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # model = kserve.models.v1alpha2_router_spec.V1alpha2RouterSpec()  # noqa: E501
        if include_optional:
            return V1alpha2RouterSpec(
    ...
    def testV1alpha2RouterSpec(self):
        """Test V1alpha2RouterSpec"""
