...
class TestV1alpha2LoRASpec(unittest.TestCase):
    """V1alpha2LoRASpec unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test V1alpha2LoRASpec
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # model = kserve.models.v1alpha2_lo_ra_spec.V1alpha2LoRASpec()  # noqa: E501
        if include_optional:
