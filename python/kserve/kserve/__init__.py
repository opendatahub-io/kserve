...
from .models.v1alpha1_llm_inference_service_config import V1alpha1LLMInferenceServiceConfig
from .models.v1alpha1_llm_inference_service_config_list import V1alpha1LLMInferenceServiceConfigList
