...
func validateTokenIsAuthenticated(w http.ResponseWriter, token string, clientset *kubernetes.Clientset) *v1.TokenReview {
...
// a meaningful status code along with a reason (if available).
func checkRequestIsAuthorized(w http.ResponseWriter, _ *http.Request, tokenReviewResult *v1.TokenReview, clientset *kubernetes.Clientset) bool {
	// Read pod namespace
	...
	accessReview := v12.SubjectAccessReview{
		Spec: v12.SubjectAccessReviewSpec{
