...
test-llmisvc: envtest
	KUBEBUILDER_ASSETS="$$($(ENVTEST) use $(ENVTEST_K8S_VERSION) -p path)" go test -v --timeout 10m ./pkg/controller/llmisvc -coverprofile coverage.out -coverpkg ./pkg/... ./cmd... -ginkgo.focus "$(FOCUS)"
